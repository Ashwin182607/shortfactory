...
## Report Bugs Using GitHub's [Issue Tracker](https://github.com/YOUR_USERNAME/shortfactory/issues)

We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.com/YOUR_USERNAME/shortfactory/issues/new).
